...
(0, _gsap.gsap).registerPlugin((0, _cssrulePlugin.CSSRulePlugin), (0, _cssplugin.CSSPlugin));
let cursorPick = document.querySelector(".cursor");
const cursor = new (0, _cursor.Cursor)(cursorPick);
...
function galleryFooter() {
    ...
    function scrollFunction() {
        if (document.body.scrollTop > 20 || document.documentElement.scrollTop > 20) // footer.style.display = "flex";
...
function pageTransition() {
    ...
    (0, _gsap.gsap).set(".exit-transition", {
        zIndex: 30,
        top: "unset",
        bottom: 0
    });
    (0, _gsap.gsap).set(".exit-span", {
        opacity: 1
    });
...
function contentAnimation() {
    ...
    var loderTl = (0, _gsap.gsap).timeline();
    var shuffleTl = (0, _gsap.gsap).timeline({
        repeat: -1
    });
    ...
    if (window.location.pathname === "/gallery.html" || window.location.pathname === "/gallery") {
        ...
        var popupTL = (0, _gsap.gsap).timeline({
            paused: true
        });
        popupTL.to(".popup", {
            duration: 0.9,
        ...
        const scrollContainer = document.getElementById("scroll");
        function testing(x) {
            if (x.matches) scrollContainer.addEventListener("wheel", (evt)=>{
                evt.preventDefault();
                scrollContainer.scrollLeft += evt.deltaY;
            });
            else scrollContainer.addEventListener("wheel", (evt)=>{
                evt.preventDefault();
    ...
    window.location.pathname === "/gallery" || window.location.pathname;
...
},{"../styles/main.scss":"bo7w8","./cursor":"3v1v0","@barba/core":"gIWbX","gsap/dist/gsap":"4wyHA","gsap/CSSPlugin":"l02JQ","gsap/CSSRulePlugin":"e8xv1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bo7w8":[function() {},{}],"3v1v0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
if (typeof window !== "undefined") window.addEventListener("mousemove", (ev)=>mouse = (0, _utils.getMousePos)(ev));
class Cursor {
    constructor(el){
        // Variables
        this.Cursor = el;
        ...
        this.onMouseMoveEv = ()=>{
            this.renderedStyles.xx.previous = this.renderedStyles.xx.current = mouse.x - this.bounds.width / 2;
            this.renderedStyles.yy.previous = this.renderedStyles.yy.previous = mouse.y - this.bounds.height / 2;
            (0, _gsapDefault.default).to(this.Cursor, {
                duration: 1,
                ease: "Power3.easeOut",
                opacity: 1
            });
...
},{"gsap/dist/gsap":"4wyHA","./utils":"72Dku","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4wyHA":[function(require,module,exports) {
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"05eeC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cVgJb","ebWYT"], "ebWYT", "parcelRequire4781")
